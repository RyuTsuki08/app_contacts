"""
Django settings for app_contacts project.
...
SECRET_KEY = 'django-insecure-)qkdg!o9)1--czz-63%jx_zm+rv@v&e5ru)u-_i2+wv!8um%s0'
...
WSGI_APPLICATION = 'app_contacts.wsgi.application'
